...
return array(
    ...
    'laravelzone\\admin\\AdminServiceProvider' => $vendorDir . '/laravelzone/admin/src/AdminServiceProvider.php',
    'laravelzone\\admin\\Console\\Commands\\InstallAdminCommand' => $vendorDir . '/laravelzone/admin/src/Console/Commands/InstallAdminCommand.php',
    'laravelzone\\admin\\Console\\Commands\\MakeMultiAuthCommand' => $vendorDir . '/laravelzone/admin/src/Console/Commands/MakeMultiAuthCommand.php',
    'laravelzone\\admin\\Console\\Commands\\RemoveAdminCommand' => $vendorDir . '/laravelzone/admin/src/Console/Commands/RemoveAdminCommand.php',
    'laravelzone\\admin\\Console\\Commands\\RoleCmd' => $vendorDir . '/laravelzone/admin/src/Console/Commands/RoleCmd.php',
    'laravelzone\\admin\\Console\\Commands\\RollbackMultiAuthCommand' => $vendorDir . '/laravelzone/admin/src/Console/Commands/RollbackMultiAuthCommand.php',
    'laravelzone\\admin\\Console\\Commands\\SeedCmd' => $vendorDir . '/laravelzone/admin/src/Console/Commands/SeedCmd.php',
    'laravelzone\\admin\\Exception\\MultiAuthHandler' => $vendorDir . '/laravelzone/admin/src/Exception/MultiAuthHandler.php',
    'laravelzone\\admin\\Http\\Middleware\\redirectIfAuthenticatedAdmin' => $vendorDir . '/laravelzone/admin/src/Http/Middleware/redirectIfAuthenticatedAdmin.php',
    'laravelzone\\admin\\Http\\Middleware\\redirectIfNotWithRoleOfAdmin' => $vendorDir . '/laravelzone/admin/src/Http/Middleware/redirectIfNotWithRoleOfAdmin.php',
    'laravelzone\\admin\\Http\\Requests\\AdminRequest' => $vendorDir . '/laravelzone/admin/src/Http/Requests/AdminRequest.php',
    'laravelzone\\admin\\Notifications\\AdminResetPasswordNotification' => $vendorDir . '/laravelzone/admin/src/Notifications/AdminResetPasswordNotification.php',
    'laravelzone\\admin\\Notifications\\RegistrationNotification' => $vendorDir . '/laravelzone/admin/src/Notifications/RegistrationNotification.php',
    'laravelzone\\admin\\traits\\MakeAdmin' => $vendorDir . '/laravelzone/admin/src/traits/MakeAdmin.php',
    'laravelzone\\admin\\traits\\RemoveAdmin' => $vendorDir . '/laravelzone/admin/src/traits/RemoveAdmin.php',
